...
public class RopeScript : MonoBehaviour
{
	...
	*/
    ...
    void BuildRope()
    {
        ...
        end.connectedBody = joints[joints.Length - 1].GetComponent<Rigidbody>();// Update by Sujit
                                                                                  // joints[joints.Length - 1].transform.rigidbody;   // Update by Sujit
    ...
    void AddJointPhysics(int n)
    {
        ...
        if (n == 1)
        {
            ph.connectedBody = transform.GetComponent<Rigidbody>(); //update by Sujit
                //transform.rigidbody;
        }
        else
        {
            ph.connectedBody = joints[n - 1].GetComponent<Rigidbody>(); //update by Sujit
                                                                        // joints[n - 1].rigidbody;
        }
